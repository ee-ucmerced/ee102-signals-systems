...
\problemset{Problem Set \#1: Introduction to Signals}
\renewcommand{\duedate}{September 9, 2026}
...
\item[(b)] Choose: $x_2(t) = \cos(3t + \pi/7)$ or if you'd like a challenge: $x_2(t) = \mathrm{e}^{\mathrm{j}\,(3t+\pi/7)}$

\item[(c)] Choose $x_3[n] = \sin(\frac{\pi n}{3} + \frac{\pi}{10})$ or if you'd like a challenge: $x_3[n] = \mathrm{e}^{\mathrm{j}\,(\tfrac{\pi}{3}n+\pi/10)}$
\end{enumerate}

...
\begin{itemize}
    \item Reminder: Problem Set \#2 due on 9/16 and Problem Set \#3 due on 9/23.
    \item Midterm Exam \#1 will be on 9/30 in-class. Problem Set \#4 will be released as a study guide for the exam.
    \item Review signal comparisons using energy computations.
    \item Learn how to break down signals using the unit step and unit impulse functions.
